...
`,
	...
	'wait_download': file => `❌ Espere hasta que finalice la descarga de \`${file}\`.`,
	'wait_conversion': file => `❌ Espere hasta que finalice la conversión de \`${file}\`.`,
	'wait_upload': file => `❌ Espere hasta que finalice la carga de \`${file}\`.`,
	'stop_download': file => `⚠️ De acuerdo, voy dejar de descargar desde \`${file}\`.`,
	'stop_conversion': file => `⚠️ De acuerdo, voy dejar de convertir desde \`${file}\`.`,
	'stop_upload': file => `⚠️ De acuerdo, voy dejar de envíar desde \`${file}\`. Es posible que el archivo aún le llegue.`,
