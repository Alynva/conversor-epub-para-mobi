...
`,
	...
	'wait_download': file => `❌ Please, wait until the download of \`${file}\` is complete. Or use /cancel to stop.`,
	'wait_conversion': file => `❌ Please, wait until the conversion of \`${file}\` is complete. Or use /cancel to stop.`,
	'wait_upload': file => `❌ Please, wait until the upload of \`${file}\` is complete. Or use /cancel to stop.`,
	'stop_download': file => `⚠️ Ok, I'll stop the download of \`${file}\`. You can send or convert other files now.`,
	'stop_conversion': file => `⚠️ Ok, I'll stop the conversion of \`${file}\`. You can send or convert other files now.`,
	'stop_upload': file => `⚠️ Ok, I'll stop the upload of \`${file}\`. It could be that the file still arrives for you, but you can send or convert other files now.`,
