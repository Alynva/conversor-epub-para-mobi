...
`,
	...
	'wait_download': file => `❌ Por favor, espere até que o download de \`${file}\` termine.`,
	'wait_conversion': file => `❌ Por favor, espere até que a conversão de \`${file}\` termine.`,
	'wait_upload': file => `❌ Por favor, espere até que o envio de \`${file}\` termine.`,
	'stop_download': file => `⚠️ Ok, eu vou parar o download de \`${file}\`.`,
	'stop_conversion': file => `⚠️ Ok, eu vou parar a conversão de \`${file}\`.`,
	'stop_upload': file => `⚠️ Ok, eu vou parar o envio de \`${file}\`. Pode ser que o arquivo ainda chegue pra você.`,
